...
const downloadAgreement = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        doc
            .fontSize(12)
            .text(`This Agreement is made as of ${new Date().toLocaleDateString()} (the “Effective Date”), by and between:`, { align: "left" });
        doc.moveDown();
        // Parties
        doc
            .fontSize(12)
        ...
        doc
            .fontSize(12)
            .text(`1.1 Property. Investor is the sole owner of the real property located at:`)
            ...
            .moveDown(0.5)
            .text(`1.2 Engagement. Investor wishes to engage Manager to manage, operate and maintain the Property, and Manager agrees to provide such services under the terms of this Agreement.`)
            .moveDown(1.5);
        // Definitions
        ...
        doc
            .fontSize(12)
            .text("Manager shall, at Manager’s expense, faithfully and to the best of its ability:", { continued: false })
            .moveDown(0.5)
            .list([
            `Leasing & Marketing:
        ...
        doc
            .fontSize(12)
            .text("4.1 Management Fee. Investor shall pay Manager a monthly fee equal to ___% of Gross Revenue, payable by the ___ day of each month.")
            .moveDown(0.5)
            .text("4.2 Leasing Fee. For each new lease executed by Manager, Investor shall pay a leasing fee of ___% of the first year’s gross rent.")
            .moveDown(0.5)
            .text("4.3 Reimbursement of Expenses. Investor shall promptly reimburse Manager for all reasonable out-of-pocket expenses incurred in the performance of its duties (e.g. maintenance, advertising, legal).")
            .moveDown(1.5);
        // Investor’s Duties
        doc
            .fontSize(14)
        ...
        doc
            .fontSize(12)
            .text("6.1 Term. This Agreement shall commence on the Effective Date and continue for ___ years, then renew automatically for successive ___-year terms unless terminated.")
            .moveDown(0.5)
            .text("6.2 Termination for Convenience. Either Party may terminate on ___ days’ prior written notice.")
            .moveDown(0.5)
            .text("6.3 Termination for Cause. Either Party may terminate immediately upon breach that is not cured within ___ days of written notice.")
            .moveDown(1.5);
        ...
        doc
            ...
            .moveDown(2)
            .text(`Investor${lease.tenant.name}: ____________________________          Date:${lease.startDate.toLocaleDateString()})`)
            .moveDown(1)
            .text(`Manager: Miles Home LTD          Date: ${lease.startDate.toLocaleDateString()})`);
        doc.end();
    }
    catch (err) {
