...
-- CreateEnum
CREATE TYPE "Highlight" AS ENUM ('HighSpeedInternetAccess', 'WasherDryer', 'AirConditioning', 'Heating', 'SmokeFree', 'CableReady', 'SatelliteTV', 'DoubleVanities', 'TubShower', 'Intercom', 'SprinklerSystem', 'RecentlyRenovated', 'CloseToTransit', 'GreatView', 'CloseToBeach', 'OceanView', 'QuietNeighborhood', 'HardwoodFloors', 'HistoricCharm');

-- CreateEnum
CREATE TYPE "Amenity" AS ENUM ('WasherDryer', 'AirConditioning', 'Dishwasher', 'HighSpeedInternet', 'HardwoodFloors', 'WalkInClosets', 'Microwave', 'Refrigerator', 'Pool', 'Gym', 'Parking', 'PetsAllowed', 'WiFi', 'Balcony', 'GymAccess', 'SmartHome', 'BoatDock', 'Elevator', 'Fireplace', 'Garden', 'RoofTerrace', 'Sauna', 'SpaAccess', 'StoneFireplace', 'Terrace');
